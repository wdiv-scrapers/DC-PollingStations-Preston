...
districts_url = "http://maps.preston.gov.uk/electionsdemocracyclub/wfs.exe?service=WFS&version=2.0.0&request=GetFeature&typeNames=ns%3AElection_District_Boundaries&outputFormat=application%2Fvnd.geo%2Bjson"
